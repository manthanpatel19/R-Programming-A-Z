...
data <- read.csv("P2-Section5-Homework-Data.csv",stringsAsFactors = TRUE)
...
add1960 <- data.frame(Code=Country_Code, Life.Exp=Life_Expectancy_At_Birth_1960,stringsAsFactors = TRUE)
add2013 <- data.frame(Code=Country_Code, Life.Exp=Life_Expectancy_At_Birth_2013,stringsAsFactors = TRUE)
